    ...
    <div class="container">
        <div class="row text-center text-md-left">
            ...
            <div class="col-md-6 mb-4 mb-md-0  d-flex flex-column align-items-center align-items-md-start">
                <img src="<?= base_url('img/asset/logo.png'); ?>" class="mb-2 " alt="Logo" height="60">
                <p class="text-muted mb-0 pr-5">Siap memberikan kebebasan bergerak dengan armada skuter terawat kami.</p>
            </div>
