    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    <td style="padding: 8px; border: 1px solid #ddd;"><strong>Durasi</strong></td>
                    <td style="padding: 8px; border: 1px solid #ddd;"><?= $days ?> hari</td>
                </tr>
                <tr>
            ...
            <p style="margin-top: 20px;">Silakan lakukan pembayaran sesuai dengan metode yang tersedia di aplikasi.</p>
            <p>Terima kasih!</p>
        </div>
        <div class="footer">
